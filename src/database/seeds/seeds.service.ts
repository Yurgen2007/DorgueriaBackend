...
export class SeedsService {
  ...
  async seed() {
    ...
    const permisos = [
      ...
      { idPermiso: 5, permiso: 'Cambiar Estado del Usuario', fkRuta: { idRuta: 1 } },
      ...
      { idPermiso: 17, permiso: 'Cambiar Estado del Sitio', fkRuta: { idRuta: 4 } },
      ...
      { idPermiso: 21, permiso: 'Cambiar estado Elemento', fkRuta: { idRuta: 6 } },
      { idPermiso: 22, permiso: 'Crear Movimiento', fkRuta: { idRuta: 7 } },
      { idPermiso: 23, permiso: 'Listar Movimientos', fkRuta: { idRuta: 7 } },
      { idPermiso: 24, permiso: 'Actualizar Movimiento', fkRuta: { idRuta: 7 } },
      { idPermiso: 25, permiso: 'Aceptar Movimiento', fkRuta: { idRuta: 7 } },
      { idPermiso: 26, permiso: 'Cancelar Movimiento', fkRuta: { idRuta: 7 } },
      ...
      { idPermiso: 31, permiso: 'Cambiar Estado del Inventario', fkRuta: { idRuta: 8 } },
      ...
      { idPermiso: 36, permiso: 'Cambiar Estado del Rol', fkRuta: { idRuta: 10 } },
      ...
      { idPermiso: 62, permiso: 'Cambiar Estado de la unidad medida', fkRuta: { idRuta: 16 } },
      ...
      { idPermiso: 66, permiso: 'Cambiar Estado de la categoria', fkRuta: { idRuta: 17 } },
      ...
      { idPermiso: 70, permiso: 'Cambiar Estado de la caracteristica', fkRuta: { idRuta: 18 } },
      { idPermiso: 71, permiso: 'Crear tipo de movimiento', fkRuta: { idRuta: 19 } },
      { idPermiso: 72, permiso: 'Listar tipos de movimientos', fkRuta: { idRuta: 19 } },
      { idPermiso: 73, permiso: 'Actualizar tipo de movimiento', fkRuta: { idRuta: 19 } },
      { idPermiso: 74, permiso: 'Cambiar Estado del tipo de movimiento', fkRuta: { idRuta: 19 } },
    ];
    ...
    const rol_permiso = [
      ...
      { idRolPermiso: 22, estado: true, fkPermiso: { idPermiso: 22 }, fkRol: { idRol: 1 } },
      { idRolPermiso: 23, estado: true, fkPermiso: { idPermiso: 23 }, fkRol: { idRol: 1 } },
      { idRolPermiso: 24, estado: true, fkPermiso: { idPermiso: 24 }, fkRol: { idRol: 1 } },
      { idRolPermiso: 25, estado: true, fkPermiso: { idPermiso: 25 }, fkRol: { idRol: 1 } },
      { idRolPermiso: 26, estado: true, fkPermiso: { idPermiso: 26 }, fkRol: { idRol: 1 } },
